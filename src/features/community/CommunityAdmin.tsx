...
export default function CommunityAdmin({ onStructureChanged }: { onStructureChanged: () => void }) {
  ...
  return <div className="community-admin">
    ...
    <Card><h2>Publish study knowledge</h2><p className="muted">Study guides, flashcards, MCQs and EMQs use the validated publisher. It accepts JSON files on Windows or pasted JSON on a tablet.</p><Link className="btn btn--primary" to="/admin">Open content publisher</Link></Card>
  </div>;
}
